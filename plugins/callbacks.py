...
async def button(bot, update):
    if update.data == "home":
        ...
        await update.edit_message_media(InputMediaPhoto(random.choice(PIC), Translation.DETAILS_TEXT.format(update.from_user.mention), enums.ParseMode.HTML), reply_markup=InlineKeyboardMarkup(buttons))
